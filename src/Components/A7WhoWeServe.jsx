...
export default function A7WhoWeServe() {
    return(
        ...
        <div className="conSec7">
          ...
          <div className="s7r1">
            ...
            <button className="registerButton right35 ButtonReverseChange">
              Register Now 
        ...
        <hr />
          ...
          <div className="s7r1">
            ...
            <button className="registerButton right20 ButtonReverseChange">
              Register Now 
              <img src={GreenArrow} alt="Green Arrow" />
            </button>
          </div>
